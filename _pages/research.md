...
Business cycles reshape product market dynamics, which exhibit substantial heterogeneity across markets. This heterogeneity arises from differences in demand structures and their interaction with entry and exit dynamics. Previous analyses have largely overlooked how product market dynamics are shaped by heterogeneous consumer demand. This paper examines how product entry and exit over the business cycle depend on the structure of consumer demand. I develop a model of strategic producer dynamics under imperfect competition with both heterogeneous producers and consumers to capture these interactions. Using detailed scanner data from the consumer goods sector, I estimate the model for each differentiated product market to analyze producer responses during the Great Recession. The findings reveal that producers respond to negative demand shocks by reducing entry and increasing exit, with the magnitude of these responses varying systematically with the price elasticity of demand. The effects are stronger in markets with less elastic demand, and the interaction between demand elasticity and product characteristics further amplifies the effects of recessions. The results also show that the welfare costs of the business cycle are substantially larger when accounting for demand heterogeneity, with most of the losses stemming from declines in consumer surplus. In the absence of consumer heterogeneity, the recovered welfare loss is significantly understated.
  </div>
